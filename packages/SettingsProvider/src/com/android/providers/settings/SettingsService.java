...
import luminedroid.providers.LumineSettings;
...
final public class SettingsService extends Binder {
    ...
    protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        try {
            if (dumpAsProto) {
                ...
                // Dump LumineSettings per user, as they would appear if listed via shell.
                ...
                for (UserInfo user : userManager.getAliveUsers()) {
                    ...
                    for (String table : Arrays.asList(tables)) {
                        pw.println("LUMINE " + table + " SETTINGS (user " + user.id + ")");
    ...
    final static class MyShellCommand extends ShellCommand {
        ...
        boolean mUseLumineSettingsProvider;
        ...
        private String getSettingsAuthority() {
            return mUseLumineSettingsProvider ? LumineSettings.AUTHORITY : Settings.AUTHORITY;
        }
        ...
        private String getCallMethod(String callMethod) {
            ...
            try {
                Class clazz = mUseLumineSettingsProvider ? LumineSettings.class : Settings.class;
        ...
        public int onCommand(String cmd) {
            ...
            do {
                ...
                } else if ("--lumine".equals(arg)) {
                    mUseLumineSettingsProvider = true;
        ...
        static void dumpHelp(PrintWriter pw, boolean dumping) {
            if (dumping) {
                ...
                pw.println("  get [--user <USER_ID> | current] [--lumine] [--deviceId <DEVICE_ID> | 0]"
                        + " NAMESPACE KEY");
                pw.println("      Retrieve the current value of KEY.");
                pw.println("  put [--user <USER_ID> | current] [--lumine] [--deviceId <DEVICE_ID> | 0]"
                ...
                pw.println("  list [--user <USER_ID> | current] [--lumine] NAMESPACE");
