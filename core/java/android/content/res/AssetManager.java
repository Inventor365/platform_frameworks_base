...
public final class AssetManager implements AutoCloseable {
    ...
    private static final String LUMINE_APK_PATH = "/system/framework/org.luminedroid.platform-res.apk";
    ...
    public static void createSystemAssetsInZygoteLocked(boolean reinitialize,
        ...
        try {
            ...
            apkAssets.add(ApkAssets.loadFromPath(LUMINE_APK_PATH, ApkAssets.PROPERTY_SYSTEM));
