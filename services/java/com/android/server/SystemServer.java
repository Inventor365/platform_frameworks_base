...
import com.android.server.luminedroid.LumineDeviceConfigService;
...
public final class SystemServer implements Dumpable {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
        ...
        if (mFactoryTestMode == FactoryTest.FACTORY_TEST_LOW_LEVEL) {
           ...
           // LumineDeviceConfigService
            t.traceBegin("StartLumimeDeviceConfigService");
            mSystemServiceManager.startService(LumineDeviceConfigService.class);
            t.traceEnd();
        ...
        String externalServer = context.getResources().getString(
                org.luminedroid.platform.internal.R.string.config_externalSystemServer);
